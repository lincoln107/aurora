...
export const FloatingCTA: React.FC = () => {
  ...
  return (
    <aside aria-label="Ação rápida de interesse" className="fixed bottom-3 left-3 right-3 sm:left-6 sm:right-6 md:left-auto md:right-8 md:bottom-6 z-40 max-w-md w-auto animate-slideUp">
      <div className="bg-stone-900/95 backdrop-blur-md border border-amber-500/40 p-4 rounded-2xl shadow-2xl shadow-black/80 flex items-center justify-between gap-4">
        {/* Info */}
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            aria-label="Fechar aviso flutuante"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
